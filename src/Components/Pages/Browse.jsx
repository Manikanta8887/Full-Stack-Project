          ...
          filteredLiveStreams.map((stream) => {
            ...
            return (
              <Col xs={24} sm={12} md={8} lg={6} key={stream.id}>
                {/* Entire card links to the watch (live stream) page */}
                <Link to={streamLink}>
                  <Card
                    hoverable
                    cover={
            ...
            <Col xs={24} sm={12} md={8} lg={6} key={stream.id}>
              ...
              >
                <Card.Meta
                  ...
                  description={
                    <>
                      <div>By {stream.streamerName || stream.streamerId || "Unknown"}</div>
                      <div>Ended on {new Date(stream.endTime).toLocaleDateString()}</div>
                    </>
                  }
                />
              </Card>
